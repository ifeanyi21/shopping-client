...
const Home = () => {
  ...
  const fetchProducts = async () => {
    ...
    setProducts(data.data.slice(17, 25));
    setLoading(false);
  };
  ...
  return (
    <div>
      ...
      <div className="container my-16 mb-16">
        <div className="row">
          <h4 className="md:text-4xl text-xl font-extrabold text-left uppercase mb-9">
            New Arrivals
          </h4>
          {loading ? (
            <div className="h-14">
      ...
      <div className="container mt-16">
        <div className="row">
          <h4 className="md:text-4xl font-semibold text-xl text-left uppercase mb-9">
            Skirts Sets
          </h4>
          {loading ? (
            <div className="h-14">
        ...
        <div className="py-5">
          ...
          <form>
            <div className="row items-center">
              <div className="col-md-9 w-4/5 flex h-11 gap-4">
                <Form.Control
                  type="email"
